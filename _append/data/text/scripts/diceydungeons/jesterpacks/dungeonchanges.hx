...
if (levelupselections.indexOf("Boosterpack:Refund,Reject,Reject") > -1){ 
...
if (levelupselections.indexOf("Boosterpack:Life Siphon,Regen,Regen") > -1){ 
  Rules.substitute("Backfire", "Leech Seed"); 
  Rules.substitute("Bop,Bop,Bop", rand(["Sweets,Harmony Orb,Sweets", "Regen,Harmony Orb,Regen", "Harmony Orb,Sweets,Harmony Orb"])); 
}
if (levelupselections.indexOf("Boosterpack:Cactus Spear,Rose Bush,Rose Bush") > -1){ 
  Rules.substitute("Backfire", "Bramble"); 
  Rules.substitute("Bop,Bop,Bop", rand(["Sour Candy,Spiked Drink,Sour Candy", "Rose Bush,Crown of Thorns,Rose Bush", "Tetraphobia,Rosebud,Tetraphobia"])); 
}
...
if (levelupselections.indexOf("Boosterpack:Eviscerate,Nosebleed,Nosebleed") > -1){ 
