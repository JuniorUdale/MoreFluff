...
var rarelist1 = ["Dramatic Entrance", "Raw Ambition", "Hookshot", "Signal Jammer", "Determination", "Dodge", "Snake Eye Charm", "Midnight Charm", "Scales of Justdice", "Meteor Hammer", "Megaclone", "Curseven","Vampire Blade","Insult to Injury","Caps Lock","Power Creeper","Sawmill","Bottled Dragonbreath","Corrosion","Quarantine","Burner Phone","Prescience","Copyrat","Ghost Blood"];
...
//Floor 4:
var commonlist3 = [chiselorcandle.pop(), "Secret Weapon", rand(["Splitula", "Spatula", "Spatuplicate"]), "Broken Mirror", "Iron Armor", "Blight", "Detonator", "Unsettling Dream", "Momentum", "Tesseract", "Envenomate","Imperishability","Mortice Lock","Hydraulic Press","Key Change"];
