...
var jester_damage_pool = ["Boxing Gloves", "Rusty Sword", "Telephone", "Elastic Heart", "Bayonet", "Pursuit", "Meteor Hammer","Backlash", "Limbo", "Kerfuffle"];
...
goodotherstuff = [
  shop(["Delete", "Flaming Sword", "Delete"], [2, 3, 2]),
  upgrade()
];
