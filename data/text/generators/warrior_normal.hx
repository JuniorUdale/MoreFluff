...
warriorshops = warriorshops.concat( ["Pike", "Zweihander", "Halberd", "Chakram", "Paintbrush", "Mace", "Pavise", "Natural Charm", "Loaded Dice", "Shotgun","Boomstick", "Blooplicate", "Trowel", "Mallet", "Frosted Dirk", "Spiked Sword", "Electroplating", "Trishula", "Tomahawk","Cat O' Six Tails", "Divine Blade", "Healing Shiv", "Venomous Goop", "Really Spiky Shield", "Nether Portal", "Ornamental Shield", "Execute", "Spikemail", "Hairdryer", "Shielding Potion", "Field Dressing", "Staff", "Plague Stave", "Asklepios","Shield Toss","Draining Crystal","Saxophone","Evocation","Revoke","Explosive Shield","Karambit","Molten Staff","Lockdown","Bloodclaw","Fruit Shooter","Juggernaut","Taunting Sword","Vine Whip","Differing Thorns","Mirror Coating","Shrug","Metal Slam","Solar Panel","Wooden Mallet","Holy Fire","Spearslinger","Sludge","Icicle Fall","Reinforce","Chitin Helmet","Sneksword","Freegen","Spire Shield"]); //modded items

shuffle(warriorshops);

var strangeshop = ["Spatula", "Lightning Rod", pick(["Shriek","Heckle"]), "Power Through", "drowS", "Expose Weakness", "Budge", "Metallicize", "Resonator",  "Leech Seed", "Panic Button", "Jade Blade", "Malediction", "Evil Eye", "Incapacitate","Chronoblade","Diamond Wall","Convergence","Shieldsplosion","Exoskeleton","First Sit","Hyena Siren"];
strangeshop = shuffle(strangeshop);

//Floor 1:
var awesomelist = ["Whip", "Hammer", "Nine Iron", "Shovel", "Talons", "Labrys", "Targe Charge", "Canesword", "Urumi", "Crass Knuckles","Metronome"]; 
...
//Floor 5:
items = [];
items.push(pick(["Counter Spell", "Shammer", "Chocolate Cookie", "Custard Cream", "Doppliduplicateinate","Shield Scrap"]));
gooditems = [];
