...
var strangeshop = ["Spatula", "Lightning Rod", "Shriek", "Juggling Ball", "Candle", "Particle Accelerator", "Flying Skull", "Sledgehammer", "Slingshot", "Fishing Net", "Scissors","Heckle", "Ferrosynthesis", "Really Spiky Shield", "Sunder","Malediction","Evil Eye","Pandemonium","Swordbroad","Third Eye","Lockdown","Flying Venus Trap","Paw Claw","Bludgeon","Twin Slam","Convergence","Shieldsplosion","Exoskeleton"];
