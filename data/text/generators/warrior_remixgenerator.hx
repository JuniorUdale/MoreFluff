...
//Floor 5:
items = [];
items.push(pick(["Counter Spell", "Pea Shooter", "Chocolate Cookie", "Toxic Ooze", "Blight", "Detonator", "Disco Ball", "Parrying Dagger", "Sine Wave", "Fishing Net", "Last Stand", "Fireworks", "Custard Cream", "Doppliduplicateinate"]));
gooditems = [];
