...
var crapstuff = shuffle(["Life Rip","Slime Ball","Stealth","Mini Missile","Blade of JOAT", "Fireflash", "Frostbitten", "Frozen Flute","Knitting Needle", "Mosquito Bite", "Magma Storm", "Cauldron Cauldron", "Drill Bit","Box of Nails","Oil Barrel","Aftershock","Frost Shield","Portavortex"]);
...
var justswords = shuffle(["Sword","Blade of Null","Mysterious Blade","Super Duper Sword","Bureaucratic Blade"]);
