...
//Floor 2:
var commonlist1 = ["Chain Mail", "Bump", "Regen", "Blood Regen", "Spike", "Keyblade", "Shotgun", "Peppergun", "Boomstick", "Sonic Blast", pick(["Pavise","Mace"]), "Focus Beam", "Solar Beam", "Terra Beam","Lunar Beam", "Scorch", "Hailstorm","Quicklime","Quicksilver","Leech Seed", "Mystic Stave", "Steamball", "Gust",  "Trishula", "Labrys", "Pee Shooter", "Medigun","Hi Vis Jacket",  "Elastic Heart", "Berlin Key", "Kalis", "Surfive", "Illumineight", "Threeken", "Nanobots","Caltrops", "Blutsauger","Star Shooter","Magma Storm", "Berserker Rage","Lifesteal", "Preparation","Defibrilator", "Pandora's Box", "Primal Slash", "Primal Punch", "Shadow Stick", "Scythe", "Sticky Sword", "Lancestave", "Sundew", "Baseball Bat", "Helmet Headbutt",dicemanip.pop(),dicemanip.pop(),dicemanip.pop()];
var shoplist1 = ["Dagger", "Boomerang", "Crystal Sword", "Venus Fly Trap", "Allen Key", "Demote", "Pockets","Six Shooter", "Focus Beam", "Solar Beam", "Terra Beam","Lunar Beam","Resonator", "Kaboomerang", "Mallet","Trowel","Cat O' Six Tails","Frosted Dirk","Healing Shiv","Venomous Goop","Screwdriver",  pick(["Gold Dagger", "Silver Dagger"]), "Lunar Beam", "Terra Beam", "Firey Firesword of Fire", "Lamppost", "Flourish", "Chromatic Cutlass", pick(["Hexatomb","Blind Rage"]),"Sledgehammer", "Magma Storm", "Flamecrower", "Kerfuffle", "Blunt Dagger", "Blunt Sword", "Slice and Dice", rand(["Blutsauger","Syringe Gun"]), "Fire Siphon", "Electrolysis", "Frost Nova", "King Rat", "Spade"];
