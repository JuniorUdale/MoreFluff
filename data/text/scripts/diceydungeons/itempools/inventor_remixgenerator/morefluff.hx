...
var scrapitems = ["Scrap Cauldron","Scrap Metal","Scrap Turret","Scraptula","Swedge","Plurale Tantrum", "Super Spatula"];
...
var midtierdrops = ["Polymorph","Petrification Spell","Fifteen Squirrels"];
