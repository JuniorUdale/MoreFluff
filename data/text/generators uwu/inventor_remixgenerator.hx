...
var elemweps = shuffle(["Spark","Snowflake","Buzzer","Whisper","Knitting Needle", "Mosquito Bite","Starshine", "Bramble", "Starshine","Jianzi","Gemstone","Burning Stick","Surprisingly Warm Rock"]);
...
var scrap = shuffle(["Scrap Nettle", "Scrap Bump", "Scrap Club", "Scrap Book", "Scrap Spear", "Scrap Kettle","Scrap Cauldron","Scrap Metal","Scrap Turret","Scraptula"]);
...
if(chance(75)){
	...
	shopideas = rand([
		...
		["Fissure","Surprisingly Warm Rock",rand(["Pyroclastic Flow","Magma Potion"])],
		["Swedge","Lucky Sword","One Weird Tip"],
