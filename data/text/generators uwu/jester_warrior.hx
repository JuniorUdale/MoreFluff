...
warriorshops = warriorshops.concat( ["Zweihander", "Halberd", "Chakram", "Paintbrush", "Flail", "Iron Fist", "Natural Charm", "Loaded Dice", "Blooplicate",  "Spiked Sword","Shield Toss","Chronoblade","Saxophone","Diamond Wall","Explosive Shield","Molten Staff","Vine Whip","Shrug"]); //modded items
